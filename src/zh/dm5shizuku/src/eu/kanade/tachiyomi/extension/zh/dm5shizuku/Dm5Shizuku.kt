package eu.kanade.tachiyomi.extension.zh.dm5shizuku
...
abstract class Dm5Shizuku :
    ...
    override fun popularMangaRequest(page: Int) = GET("$baseUrl/bookmarker/", headers)
    ...
    private fun popularMangaFromElement(element: Element): SManga = SManga.create().apply {
        ...
        thumbnail_url = element.selectFirst(".mh-cover")?.attr("style")
